...
public class CompareJsonTest {
    ...
    public void testCompareJson(String actualJson, String expectJson, String expectedStr) {
        // 测试比对
        Map<String, String> actualMap = JsonUtils.compareJson(actualJson, expectJson);
        System.out.println("比对结果 Map=" + JsonUtils.writeValueAsString(actualMap));

        // 解析预期结果
        Map<String, String> expectedMap = JsonUtils.readValue(expectedStr, new TypeReference<>() {});
